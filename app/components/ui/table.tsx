                ...
                <tr className="bg-dark-grey border-b-[1px] border-dark-grey/10">
                    {
                        props.tableHeaders.map((header, index) => {
                            return (
                                <th
                                    key={index}
                                    className={`text-sm font-semibold text-primary whitespace-nowrap p-3 text-left bg-dark-grey ${props.tableHeaderStyle}`}>
                                    {header}
                                </th>
                            )
                        })
                    ...
                    !props.isLoading && props.tableRowsData.map((row, index) => {
                        return (
                            <tr key={index}
                                ...
                                className={`border-b-[1px] border-dark-grey/10 text-sm last:border-b-0 
